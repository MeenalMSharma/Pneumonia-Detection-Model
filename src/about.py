...
def main(): 
    ...
    with col1:
      ...
      with col2:
         st.image("https://drive.google.com/file/d/1wQ_OG-5wnpDtPx4p0WFUwtcggb330ijl/view?usp=sharing", width = 260)
    ...
    with col2:
         st.image("https://drive.google.com/file/d/1wadp8dr8U-6c2VBBqNO3elltyDH1kmvh/view?usp=sharing", width = 260)
